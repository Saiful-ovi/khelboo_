            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <a href="index.html" class="logo">
                        <img src="photos/1.png" alt="" style="width:250px;"">
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="caption header-text">
            <h6>Welcome to Khelboo.com</h6>
            <h2>BEST TURF EVER!</h2>
            <p >Khelboo Turf is a state-of-the-art sports complex in Bangladesh that offers a wide range of sports and recreational activities. With top-notch facilities, inclusive environment, and various programs, Khelboo Turf is a go-to destination for sports enthusiasts of all ages and abilities.</p>
